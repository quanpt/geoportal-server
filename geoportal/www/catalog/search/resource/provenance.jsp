...
<% // initialize the page %>
<gpt:page id="catalog.search.resource.provenance" prepareView="#{ProvenanceController.processRequestParams}"/>
<tiles:insert definition=".gptLayout" flush="false" >
  ...
  <tiles:put name="body" value="/catalog/search/resource/provenanceBody.jsp"/>
</tiles:insert>